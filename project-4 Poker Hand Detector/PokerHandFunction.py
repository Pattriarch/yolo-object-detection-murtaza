def findPokerHand(hand):
    ...
    # сначала проверим, что все suit одинаковы
...
if __name__ == '__main__':
    ...
    findPokerHand(['2D', '3D', '4D', '5D', '6C'])  # Straight
    findPokerHand(['3D', '3C', '3H', 'KH', 'QC'])  # Three of a Kind
    findPokerHand(['2D', '2C', '4D', '4Q', '6C'])  # Two Pair
    findPokerHand(['2D', '3D', '2Q', '5D', '8C'])  # Pair
    findPokerHand(['KH', '3D', '5C', '9H', '6C'])  # High Card
